...
| 🔊 **[`output_th.wav`](backend/samples/output_th.wav)** | 102.1 s | Thai risk assessment — JaiTTS/F5 @ 1.0× + silence-trim · **6 chunks** |
...
[6] TTS    ✓ EN 7 chunks / 52 s   ·   TH 6 chunks / 102 s
```
...
| Thai TTS (JaiTTS/F5) | flow-matching; pace via `JAITTS_SPEED` (default 1.0 + silence-trim) |
